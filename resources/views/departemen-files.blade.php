            ...
            <div class="modal-body">
                <form id="shareForm">
                    <div class="mb-3">
                        ...
                        <select id="selectUser" class="form-select select2" multiple="multiple" style="width: 500px;" required>
                            <option value="">Pilih Pengguna</option>
                            @foreach ($users as $user)
                            <option value="{{ $user->id }}">{{ $user->name }} - {{ $user->pegawai->department->name}}</option>
                            @endforeach
                        </select>
                    </div>
